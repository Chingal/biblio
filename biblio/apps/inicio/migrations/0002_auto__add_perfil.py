...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perfil'
        db.create_table(u'inicio_perfil', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('telefono', self.gf('django.db.models.fields.IntegerField')(max_length=15)),
        ))
        db.send_create_signal(u'inicio', ['Perfil'])


    def backwards(self, orm):
        # Deleting model 'Perfil'
        db.delete_table(u'inicio_perfil')
    ...
    models = {
        ...
        u'inicio.perfil': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'telefono': ('django.db.models.fields.IntegerField', [], {'max_length': '15'}),
